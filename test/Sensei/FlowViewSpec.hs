  ...
  describe "normalizeViewsForDay" $ do
    it "extend last view when it's not ended" $ do
      ...
      normalizeViewsForDay startTime endTime [view]
        `shouldBe` [FlowView (LocalTime (toEnum 5000) (TimeOfDay 8 0 0)) (LocalTime (toEnum 5000) (TimeOfDay 18 0 0)) (FlowType "Meeting")]
    ...
    it "append Other view at end of last view given it does not end the day" $ do
      ...
      normalizeViewsForDay startTime endTime [view]
        `shouldBe` [ FlowView (LocalTime (toEnum 5000) (TimeOfDay 8 0 0)) (LocalTime (toEnum 5000) (TimeOfDay 17 0 0)) (FlowType "Meeting"),
    ...
    it "extending last view preserves other views" $ do
      ...
      normalizeViewsForDay startTime endTime [view1, view2]
        `shouldBe` [view1, FlowView (LocalTime (toEnum 5000) (TimeOfDay 10 0 0)) (LocalTime (toEnum 5000) (TimeOfDay 18 0 0)) (FlowType "Meeting")]
